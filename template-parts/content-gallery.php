...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
        ...
        if( has_post_thumbnail( ) ) {
            echo '<div class="post-image"><span class="secondary-background icon-post-type"><i class="fa fa-camera"></i></span>';
	...
	<div class="entry-content">
		<div class="entry-content-inner">
			<?php echo apply_filters('the_content', preg_replace('/\[gallery(.*)]/', '', get_the_excerpt())); ?>
		</div>
