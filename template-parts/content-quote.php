...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
        ...
        if( has_post_thumbnail( ) ) {
            echo '<div class="post-image"><span class="secondary-background icon-post-type"><i class="fa fa-quote-left"></i></span>';
	...
	<div class="entry-content">
		<div class="entry-content-inner">
			<?php echo substr(preg_replace('/\<blockquote\>(.*)\<\/blockquote\>/', '', get_the_content()), 0, 280); ?>
		</div>
