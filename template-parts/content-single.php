...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
        ...
        if( has_post_thumbnail( ) ) {
            ...
            echo '<div class="post-image"><span class="secondary-background icon-post-type"><i class="fa fa-image"></i></span><div class="post-image-inner"><a class="imgzoom image-popup" href="'.$imgzoom[0].'"><i class="fa fa-search-plus"></i></a></div>';
