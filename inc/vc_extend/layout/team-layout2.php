<div class="st-team-wraper st-team-<?php echo esc_attr($consultancy_team_template).' '.esc_attr($consultancy_team_image);?>">
    <div class="st-team-inner clearfix">
        ...
        <div class="st-team-desctiption">
            <?php echo esc_attr($consultancy_team_description); ?>
        </div>
        ...
        <div class="st-team-social">
            ...
            <a class="team-social" title="Facebook" href="<?php echo esc_attr($consultancy_team_google); ?>" target="_blank"><i class="fa fa-google"></i></a>
        </div>
