...
if ( $consultancy_button_template == 'ocustom' && $consultancy_button_custom_color ) {
    $button_styles[] = 'border-color: ' . $consultancy_button_custom_color . ';';
    $button_styles[] = 'color: ' . $consultancy_button_custom_text_color . ';';
}
