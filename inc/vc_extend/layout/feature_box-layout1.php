    ...
    <div class="st-feature-box">
        ...
        <?php if($consultancy_feature_button_text!=''):?>
            <div class="st-feature-box-button">
                ...
                ?>
                <a href="<?php echo esc_url($consultancy_feature_button_link);?>" class="primary-color primary-hover-color st-feature-more <?php echo esc_attr($consultancy_feature_extra_class_btn);?>"><?php echo esc_attr($consultancy_feature_button_text);?></a>
            </div>
        <?php endif;?>
    </div>
</div>