...
if ( $consultancy_call_to_action_button_template == 'layout7' ) {
    $button_class[] = ' tertiary-background secondary-background-hover';
}
...
<div class="call-to-action call-to-action-<?php echo esc_attr($consultancy_call_to_action_template); ?>">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 call-to-action-button <?php echo esc_attr($consultancy_call_to_action_button_align); ?>">
